...
const ClosingSetupPanel = () => {
    ...
    const [selectedUsers, setSelectedUsers] = useState(Array(5).fill(null));
    ...
    }, [startDate, endDate, selectedUsers, mode]);
    ...
    }, [saved, workers, jobs, todayStr, startDate, endDate, scheduleMap, mode]);
    ...
    }, [saved, workers, jobs, startDate, endDate, scheduleMap, mode]);
